...
const Figure = styled.figure`
    width: ${props => props.$expandida ? '30%' : '30%'};
    max-width: 30%;
    margin: 0;
    display: flex;
...
const Imagen = ({ foto, expandida = false, fotoSelecionada, alAlternarFavorito}) => {
        ...
        <Figure $expandida={expandida} id={`foto-${foto.id}`}>
            ...
            <figcaption>
                ...
                <Pie>
                    ...
                    {!expandida && <BotonIcono aria-hidden={expandida} onClick={()=>fotoSelecionada(foto)}>
